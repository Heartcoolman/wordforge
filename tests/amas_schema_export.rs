...
//! 2. 把当前 schema 离线写入 `frontend/src/types/amas.schema.json`，
...
fn export_amas_config_schema_to_frontend() {
    ...
    path.push("frontend/src/types/amas.schema.json");
