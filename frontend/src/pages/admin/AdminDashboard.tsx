...
export default function AdminDashboard() {
  ...
  const [health, setHealth] = createSignal<{ status: string; dbSizeBytes: number; uptime: number; version: string } | null>(null);
          ...
          {(h) => (
            <Card variant="elevated">
              ...
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div><p class="text-content-secondary">运行时间</p><p class="font-medium text-content">{Math.floor(h().uptime / 3600)} 小时</p></div>
